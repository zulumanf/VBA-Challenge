...
Sub Stock_Analysis_Homwork()
    ...
    For Each ws In Worksheets
        ...
        'Set variable for volume traded, set it equal to 0
        ...
        'Set variable to hold year open price, set it equal to 0
        Dim year_open As Double
        year_open = 0

        'Set variable to hold year close price, set it equal to 0
        Dim year_close As Double
        year_close = 0
        
        'Set variable to hold the change in price for the year, set it equal to 0
        Dim year_change As Double
        year_change = 0

        'Set variable to hold the percent change in price for the year, set it equal to 0
        ...
        For i = 2 To lastrow
            ...
            'Conditional to grab year open price, if cell above is different, then new ticker has started and open value as a result
